...
$sqlcek="SELECT password_admin FROM administrator WHERE username='".$_SESSION['username']."'";
$rscek=mysql_query($sqlcek);
$cek=mysql_fetch_array($rscek);

if ($passLama!=$cek['password_admin']) {
   echo "<script>
   ...
   alert('Password Baru Tidak Sama');
	location.href='home.php?module=ubah_password.php';</script>";
		...
		$sql="UPDATE administrator SET password_admin='".$passBarus."' WHERE username='".$_SESSION['username']."'";
		$rs=mysql_query($sql);
		echo "<script>
